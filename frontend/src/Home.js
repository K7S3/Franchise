  ...
  return (
    <div className="homePage">
      ...
      <div className="step-content">
        ...
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSecij6_kgpIx5nCQ9C0u3VThAcV748dyYaBI8ATXD-er7k2WA/viewform?usp=sf_link" className="btn btn-success" target="_blank">Click Here! </a>
      </div>
    </div>
    </div>
  );
